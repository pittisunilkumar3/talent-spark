...
module.exports = {
  async up (queryInterface, Sequelize) {
    await queryInterface.createTable('employee_interview_calendar_events', {
      id: {
    ...
    await queryInterface.addConstraint('employee_interview_calendar_events', {
    ...
    // Add indexes
    await queryInterface.addIndex('employee_interview_calendar_events', ['event_id'], { name: 'event_id_idx' });
    await queryInterface.addIndex('employee_interview_calendar_events', ['sync_status'], { name: 'sync_status_idx' });
    await queryInterface.addIndex('employee_interview_calendar_events', ['is_active'], { name: 'is_active_idx' });
  },

  async down (queryInterface, Sequelize) {
    await queryInterface.dropTable('employee_interview_calendar_events');
  }
};
