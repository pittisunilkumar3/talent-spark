...
module.exports = {
  async up (queryInterface, Sequelize) {
    await queryInterface.createTable('user_interview_schedules', {
      id: {
    ...
    // Add indexes
    await queryInterface.addIndex('user_interview_schedules', ['user_id'], { name: 'user_id_idx' });
    await queryInterface.addIndex('user_interview_schedules', ['job_id'], { name: 'job_id_idx' });
    await queryInterface.addIndex('user_interview_schedules', ['scheduled_date'], { name: 'scheduled_date_idx' });
    await queryInterface.addIndex('user_interview_schedules', ['status'], { name: 'status_idx' });
    await queryInterface.addIndex('user_interview_schedules', ['decision'], { name: 'decision_idx' });
    await queryInterface.addIndex('user_interview_schedules', ['round'], { name: 'round_idx' });
    await queryInterface.addIndex('user_interview_schedules', ['interview_type'], { name: 'interview_type_idx' });
    await queryInterface.addIndex('user_interview_schedules', ['is_active'], { name: 'is_active_idx' });
  ...
  async down (queryInterface, Sequelize) {
    await queryInterface.dropTable('user_interview_schedules');
  }
};
